 ...
 * @internal    @properties &param_tv_id=ID TV параметров товара;string; &param_tv_id_simple=ID TV параметров товара (простой фильтр);string; &product_templates_id=ID шаблонов товара;string; &param_cat_id=ID категории параметров;string; &exclude_tvs_from_list=Не включать ТВ в параметры при выводе;string; &tovarChunkName=Имя чанка вывода товара;string; &pattern_folder=Папка паттернов;string;assets/images/pattern/; &category_template=Список шаблонов категорий;string;1
 * @internal	@modx_category Filters
 * @internal	@enable_sharedparams 1
